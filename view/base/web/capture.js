requirejs(["jquery", "mage/url", "domReady"], function ($, urlBuilder) {
  ...
  (function (window, undefined) {
    ...
    * @param {Object} [options] - An object containing request configuration options. */
    pca.Request = pca.Request || function (service, data, success, error, options) {
      ...
      request.destination = options.endpoint.literal ? request.service : pca.protocol + "//" + pca.host + "/" + request.service + "/" + pca.endpoint;
      request.query = "";
    ...
    * @param {pca.Request~errorCallback} [error] - A callback function for errors.
    * @param {Object} [options] - An object containing request configuration options.*/
    pca.fetch = pca.fetch || function (service, data, success, error, options = {}) {
    ...
    * @returns {string} The value of the element. */
    ...
    pca.reactTriggerChange = pca.reactTriggerChange || function reactTriggerChange(node) {
    ...
    * @param {*} value - The value to set. */
    pca.setValue = pca.setValue || function (element, value, simulateReactTrigger) {
  ...
  /*3.92 - No changes, just to move inline with update version*/
  (function () {
    var pca = window.pca = window.pca || {};
    ...
    */
    pca.Address = function (fields, options) {
      ...
      function parseOptions(options) {
        ...
        options.simulateReactEvents = typeof (options.simulateReactEvents) == "boolean" ? options.simulateReactEvents : false;
        ...
        options.endpoint.find = options.endpoint.find || "Capture/Interactive/Find/v1.00";
        options.endpoint.retrieve = options.endpoint.retrieve || "Capture/Interactive/Retrieve/v1.00";
      ...
      address.load = function () {
        ...
        address.countrylist.autocomplete.listen("hide", function () {
          ...
          if (address.storedSearch != null)
            pca.setValue(address.autocomplete.field, address.storedSearch, address.options.simulateReactEvents);
      ...
      address.search = function (term) {
        ...
        if (address.autocomplete.addUtilityLookupToTop) {
          ...
          if (search.text) {
            ...
            pca.fetch(address.options.endpoint.find, searchParameters, success, address.error, requestOptions);
          }
        }
      ...
      * @param {string} id - The address id to retrieve. */
      address.retrieve = function (id) {
        ...
        pca.fetch(address.options.endpoint.retrieve, params, success, fail, requestOptions);
      };
      ...
      address.select = function (suggestion) {
        ...
        function filterSearch() {
          ...
          if (address.options.setCursor) {
            ...
            pca.setValue(address.autocomplete.field, searchText + " ", address.options.simulateReactEvents);
      ...
      * @fires populate */
      address.populate = function (items) {
        ...
        for (var a = 0; a < address.fields.length && address.options.populate; a++) {
          ...
          pca.setValue(field.element, value, address.options.simulateReactEvents);
        }
      ...
      * @fires clear */
      address.clear = function () {
        for (var a = 0; a < address.fields.length; a++)
          pca.setValue(address.fields[a].element, "", address.options.simulateReactEvents);
