/**
 * @fileoverview PCA SDK – country data: ISO country array and countryNameType enum.
 *
 * Provides:
 * - `pca.countries` — array of 250+ country objects, each with `iso2`, `iso3`,
 *   `name`, `name_fr`, optional `alternates[]`, and `flag` (sprite-sheet index).
 * - `pca.countryNameType` — enum controlling whether a country input field is
 *   populated with the full name, ISO 2-char code, or ISO 3-char code.
 *
 * Consumed by {@link pca.CountryList} to build the flag-icon autocomplete selector.
 *
 * Depends on: {@link module:pca/core}.
 *
 * @module pca/countries/data
